...
def get_spectral_vects(obj, spk, phone):
    spectral_vects = []
...
spectral_vects = get_spectral_vects(obj, spk, phone)
...
plt.bar(ind, channel_means, width, colour='blue', yerr=channel_stds, label='Spectral Vectors')
plt.bar(ind+width, attacked_channel_means, width, colour='red', label='Attacked Spectral Vectors')
