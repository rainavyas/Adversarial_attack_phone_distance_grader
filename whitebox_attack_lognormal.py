...
import numpy as np
from attack_models_lognormal_approx import Spectral_attack_lognormal
import math
import argparse
import sys
import os
...
attack_model = Spectral_attack_lognormal(spectral_dim, mfcc_dim, trained_model_path, init_root).to(device)
...
# save the model
output_file = "attack_model_lognormal"+str(barrier_val)+"_seed"+str(seed)+".pt"
